    ...
    <>
      <ScrollView style={styles.container} >
        ...
        <View style={styles.information} >
          <Text style={styles.inputLabel} >Q. What is Organizer UPI?</Text>
          <Text style={styles.informationText} >
            UPI = Unified Payment Interface{`\n`}
            Enter your UPI address which will be used for payment collection from users. {`\n`}
            Please enter valid upi address to ensure seamless payment.
        </Text>
        </View>
        {
